            ...
            impact_instances.append(
                cls(
                    ...
                    constraint_annual = (
                        ...
                        data=group_to_json(
                            g=df_constraint_annual.loc[df_constraint_annual['EMISSION']==emission],
                    ...
                    constraint_total = (
                        RegionTechnologyYearData(
                        data=group_to_json(
                            g=df_constraint_total.loc[df_constraint_total['EMISSION']==emission],
                            root_column='EMISSION',
                            data_columns=['REGION'],
                            target_column='VALUE',
                            )
                    ...
                    exogenous_annual = (
                        RegionTechnologyYearData(
                        data=group_to_json(
                            g=df_exogenous_annual.loc[df_exogenous_annual['EMISSION']==emission],
                            root_column='EMISSION',
                            data_columns=['REGION','YEAR'],
                            target_column='VALUE',
                            )
                    ...
                    exogenous_total = (
                        RegionTechnologyYearData(
                        data=group_to_json(
                            g=df_exogenous_total.loc[df_exogenous_total['EMISSION']==emission],
                            root_column='EMISSION',
                            data_columns=['REGION'],
                            target_column='VALUE',
                            )
